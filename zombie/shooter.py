...
# set up images
playerImage = pygame.transform.scale(pygame.image.load('oski.tiff'), (WINDOWWIDTH/16, WINDOWHEIGHT/8))
playerRect = playerImage.get_rect()

bulletImage = pygame.transform.scale(pygame.image.load('seal.png'), (50, 50))
bulletRect = bulletImage.get_rect()

zombieImage = pygame.image.load('tree.png')
newKindZombieImage = pygame.image.load('ucla.png')
...
drawText('Berkeley Defence by Anova', font, windowSurface, (WINDOWWIDTH / 4), (WINDOWHEIGHT / 4))
